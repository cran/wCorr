...
```{r rmseVersusN, echo=FALSE,fig.width=7, fig.height=3.5}
...
```{r timeVersusN, echo=FALSE,fig.width=7, fig.height=4}
...
```{r wgtVersusRhoPlot, echo=FALSE,fig.width=7, fig.height=5.5}
# wgt <- wgtvrho
...
```{r wgtVsNPlot, echo=FALSE,fig.width=7, fig.height=5.5}
