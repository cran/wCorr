...
```{r packagesAndData, echo=FALSE, results="hide", message=FALSE,warning=FALSE}
require(knitr)
require(wCorr)
require(lattice)
require(captioner)
...
```{r setupFast, echo=FALSE, results="hide", message=FALSE, warning=FALSE}
...
```{r tablesAndFigures, echo=FALSE, results="hide", message=FALSE,warning=FALSE}
fig_nums <- captioner()
...
```{r fastMADplot, echo=FALSE,fig.width=7, fig.height=3.5}
...
```{r plotSpeed, echo=FALSE,fig.width=7, fig.height=3.5}
